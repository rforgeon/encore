...
These eval cases check the behavior of the `encore-service-builder` agent plugin, not Encore itself. They are meant to verify that the plugin produces useful plans, safe boundaries, and concrete acceptance checks for common Encore workflows.
